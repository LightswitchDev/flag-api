...
```json
{
  ...
  "params": {
    "projectInfo": "",
    "force": true,
    "migrationId": "watch-20200119232442",
    "steps": [
      {
        "tag": "CreateModel",
        "model": "Key"
...
## Stack Trace
```bash
Jan 19 23:23:07.881  INFO migration_engine: Starting migration engine RPC server git_hash="e7579bd35e0938dbf773f1706c098a0d14a5a038"
Jan 19 23:23:07.890  INFO quaint::single: Starting a postgresql pool with 1 connections.    
Jan 19 23:23:07.897  INFO ListMigrations: migration_engine::commands::list_migrations: Returning 11 migrations (0 pending).
Jan 19 23:23:07.965  INFO ListMigrations: migration_engine::commands::list_migrations: Returning 11 migrations (0 pending).
Jan 19 23:24:25.284  INFO ListMigrations: migration_engine::commands::list_migrations: Returning 12 migrations (0 pending).
Jan 19 23:24:42.049  INFO ListMigrations: migration_engine::commands::list_migrations: Returning 13 migrations (0 pending).
```
