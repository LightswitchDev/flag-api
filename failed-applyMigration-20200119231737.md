...
```json
{
  ...
  "params": {
    "projectInfo": "",
    "force": true,
    "migrationId": "watch-20200119231724",
    "steps": [
      {
        "tag": "CreateModel",
        "model": "Key"
...
## Stack Trace
```bash
Jan 19 23:17:24.541  INFO migration_engine: Starting migration engine RPC server git_hash="e7579bd35e0938dbf773f1706c098a0d14a5a038"
Jan 19 23:17:24.550  INFO quaint::single: Starting a postgresql pool with 1 connections.    
Jan 19 23:17:24.557  INFO ListMigrations: migration_engine::commands::list_migrations: Returning 9 migrations (0 pending).
Jan 19 23:17:24.614  INFO ListMigrations: migration_engine::commands::list_migrations: Returning 9 migrations (0 pending).
```
